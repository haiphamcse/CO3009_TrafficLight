...
uint16_t button[BUTTON_COUNT] = {A1_Pin, A2_Pin, A3_Pin};
GPIO_TypeDef * button_gpio[BUTTON_COUNT] = {A1_GPIO_Port, A2_GPIO_Port, A3_GPIO_Port};
//NOTE: DIFFERENT PINS HAVE DIFFERENT GPIO CONFIG, SO TO BE SURE, WE WILL SET GPIO FOR ALL BUTTONS

uint16_t led[4] = {D2_Pin, D3_Pin, D5_Pin, D4_Pin};
GPIO_TypeDef * led_gpio[4] = {D2_GPIO_Port, D3_GPIO_Port, D5_GPIO_Port, D4_GPIO_Port};
//NOTE: LEDS
...
int timer_delay[TIMER_COUNT] = {100, 100};
